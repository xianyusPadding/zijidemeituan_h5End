$(function(){
		...
		function show_res(){
			...
			store.openCursor().onsuccess = function(event){
				...
				if(cursor){
					...
					if(cursor){
						fl_main2_addres += "<div class='row  fl-indexMain2-details'><div class='col-xs-3'><input type='hidden' value='"+cursor.value.res_img+"'><img class='fl-restaurentImg' src='" +
	...
	req.onupgradeneeded = function(e){
		...
		objectStore.createIndex("res_perPrice", "res_perPrice", {unique: false});
		//要增加的数据Array1
		const restaurantData = [
			{res_img:"images/restaurant2.jpg", res_title:"餐中饮重庆烤鱼店",res_price:"￥45/人",res_activity:"双人套餐68，4人套餐88元，6人套餐108元", res_perPrice:"￥45"},
			{res_img:"images/restaurant3.jpg", res_title:"黑龙茶",res_price:"￥10/人",res_activity:"5.9元抹绿奶茶，14.8元优惠饮品双杯", res_perPrice:"￥10"},
			{res_img:"images/restaurant4.jpg", res_title:"万岁寿司",res_price:"￥16/人",res_activity:"12元超值单人A餐，14元超值单人B餐，15元...", res_perPrice:"￥35"}
		];
